...
class Scheduler{ 
    ...
    { 
        ...
        int[] arrivaltime=new int[num];  //arrival time

        int[] bursttime=new int[num];   //burst time

        for(int i=0;i<num;i++)
            {
                System.out.println("Arrival Time[P"+i+"]=");
                arrivaltime[i]=scan.nextInt();

                System.out.println("Burst Time[P"+i+"]=");
